            ...
            <div className="inner-page__wrapper">
              ...
              <div className="gym-catalog-form">
                ...
                <div className="gym-catalog-form__wrapper">
                  <Link className="btn-flat btn-flat--underlined gym-catalog-form__btnback" to={AppRoute.Main}>
                    ...
                    <div className="thumbnail-training">
                      <div className="thumbnail-training__inner">
                        ...
                        <div className="thumbnail-training__button-wrapper">
                          <Link className="btn btn--small thumbnail-training__button-catalog" to={AppRoute.Main}>Подробнее</Link>
                          <Link className="btn btn--small btn--outlined thumbnail-training__button-catalog" to={AppRoute.Main}>Отзывы</Link>
                        </div>
                      </div>
                    </div>
                  </li>
                  ...
                  <li className="training-catalog__item">
                    <div className="thumbnail-training">
                      <div className="thumbnail-training__inner">
                        ...
                        {/* <div className="thumbnail-training__button-wrapper">
                          <Link className="btn btn--small thumbnail-training__button-catalog" href="#">Подробнее</Link>
                          <a className="btn btn--small btn--outlined thumbnail-training__button-catalog" href="#">Отзывы</a>
                        </div> */}
                      </div>
                    </div>
