        ...
        <div className="container"><a className="header__logo" href="index.html" aria-label="Переход на главную">
          ...
          <nav className="main-nav">
            <ul className="main-nav__list">
              ...
              <li className="main-nav__item"><Link className="main-nav__link" to={AppRoute.Main} aria-label="Личный кабинет">
                  <svg width="16" height="18" aria-hidden="true">
                    <use xlinkHref="#icon-user"></use>
                  </svg></Link></li>
              <li className="main-nav__item"><Link className="main-nav__link" to={AppRoute.Main} aria-label="Друзья">
                  <svg width="22" height="16" aria-hidden="true">
                    <use xlinkHref="#icon-friends"></use>
                  </svg></Link></li>
              <li className="main-nav__item main-nav__item--notifications"><Link className="main-nav__link" to={AppRoute.Main} aria-label="Уведомления">
                ...
                <div className="main-nav__dropdown">
                  ...
                  <ul className="main-nav__sublist">
                    <li className="main-nav__subitem"><Link className="notification is-active" to={AppRoute.Main}>
                        <p className="notification__text">Катерина пригласила вас на&nbsp;тренировку</p>
                        <time className="notification__time" dateTime="2023-12-23 12:35">23 декабря, 12:35</time></Link>
                    </li>
                    <li className="main-nav__subitem"><Link className="notification is-active" to={AppRoute.Main}>
                        <p className="notification__text">Никита отклонил приглашение на&nbsp;совместную тренировку</p>
                        <time className="notification__time" dateTime="2023-12-22 09:22">22 декабря, 09:22</time></Link>
                    </li>
                    <li className="main-nav__subitem"><Link className="notification is-active" to={AppRoute.Main}>
                        <p className="notification__text">Татьяна добавила вас в&nbsp;друзья</p>
                        <time className="notification__time" dateTime="2023-12-18 18:50">18 декабря, 18:50</time></Link>
                    </li>
                  </ul>
                </div>
              </li>
          ...
          <div className="search">
            <form action="#" method="get">
              ...
              <ul className="search__list">
                <li className="search__item"><Link className="search__link" to={AppRoute.Main}>Бокс</Link></li>
                <li className="search__item"><Link className="search__link is-active" to={AppRoute.Main}>Бег</Link></li>
                <li className="search__item"><Link className="search__link" to={AppRoute.Main}>Аэробика</Link></li>
                <li className="search__item"><Link className="search__link" to={AppRoute.Main}>Text</Link></li>
                <li className="search__item"><Link className="search__link" to={AppRoute.Main}>Text</Link></li>
                <li className="search__item"><Link className="search__link" to={AppRoute.Main}>Text</Link></li>
                <li className="search__item"><Link className="search__link" to={AppRoute.Main}>Text</Link></li>
                <li className="search__item"><Link className="search__link" to={AppRoute.Main}>Text</Link></li>
